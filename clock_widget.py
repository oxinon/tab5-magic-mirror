...
class ClockWidget:
    def __init__(self, parent, format24h=True, show_seconds=True, show_date=True, align="left"):
        ...
        # eine "8"), und die Flex-Ausrichtung verschiebt dann bei JEDEM
        # Sekundenwechsel die ganze Box neu - sichtbares Zittern. MIT
        # fester Breite bleibt die Box immer gleich groß, nur die
        # Textposition INNERHALB verschiebt sich (via text_align), und
        # zwar exakt so, dass die Kante zum Rand hin immer an derselben
        # Pixel-Position bleibt.
        self.time_label.set_width(290)
